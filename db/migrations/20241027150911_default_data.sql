...
VALUES (1, 'U2U', 'Nebulas Testnet', 'https://rpc-nebulas-testnet.uniultra.xyz', 2484, 'https://testnet.u2uscan.xyz/', 0, 500);

INSERT INTO chains (id, chain, name, rpc_url, chain_id, explorer, latest_block, block_time)
VALUES (2, 'U2U', 'Solaris Mainnet', 'https://rpc-mainnet.uniultra.xyz', 39, 'https://u2uscan.xyz/', 0, 2000);
